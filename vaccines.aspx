<%@ Page Title="Vaccines" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="vaccines.aspx.cs" Inherits="Seabase.vaccines" %>
                ...
                <div class="col-md-12">
                      <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title animated slideInRight">Vaccines</h3>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="text-primary">Vaccine Name:</label><br />
                ...
                <div class="modal-footer">
                    <button id="save" class="btn btn-primary">Save Vaccine
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-info text-primary"></i></span>
                                    <input type="number" id="days-edit" class="form-control" data-name="Days"/>
                                </div>
...
<script src="scripts/WebForms/vaccine.js"></script>
</asp:Content>
