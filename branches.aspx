<%@ Page Title="Branches" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="branches.aspx.cs" Inherits="Seabase.branches" %>
                ...
                <div class="col-md-12">
                      <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title animated slideInRight">Branches</h3>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button id="save" class="btn btn-primary">Save Branch
...
<script src="scripts/WebForms/branch.js"></script>
</asp:Content>
