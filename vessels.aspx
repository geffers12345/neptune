<%@ Page Title="Vessel Types" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="vessels.aspx.cs" Inherits="Seabase.vessels" %>
                ...
                <div class="col-md-12">
                      <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title animated slideInRight">Vessel Types</h3>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-8">
                                            <button data-toggle="modal" data-target="#addModal" class="btn btn-primary btn-add">
                                              Add New Vessel Type
                                                <span class="tooltiptext">Click to add new vessel</span>
                                            </button>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
...
<script src="scripts/WebForms/vessel.js"></script>
</asp:Content>
