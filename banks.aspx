<%@ Page Title="Banks" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="banks.aspx.cs" Inherits="Seabase.banks" %>
                ...
                <div class="col-md-12">
                      <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title animated slideInRight">Banks</h3>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button id="save" class="btn btn-primary">Save Bank
...
<script src="scripts/WebForms/bank.js"></script>
</asp:Content>
