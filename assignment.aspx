<%@ Page Title="Vessel Assignment Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="assignment.aspx.cs" Inherits="Seabase.assignment" %>
            ...
            <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title animated slideInRight">Vessel Assignment Details</h3>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-info text-primary"></i></span>
                                                <input type="text" id="requested" class="form-control" data-name="Requested" disabled/>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-info text-primary"></i></span>
                                                <select id="user" class="form-control" disabled></select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-info text-primary"></i></span>
                                                <input type="date" id="recieved-date" class="form-control" data-name="Recieved Date" disabled/>
                                            </div>
