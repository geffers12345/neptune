<%@ Page Title="Airlines" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="airlines.aspx.cs" Inherits="Seabase.airlines" %>
                ...
                <div class="col-md-12">
                      <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title animated slideInRight">Airlines</h3>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-8">
                                            <button data-toggle="modal" data-target="#addModal" class="btn btn-primary btn-add">
                                              Add New Airline
                                                <span class="tooltiptext">Click to add new airline</span>
                                            </button>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="text-primary">Airline Name:</label><br />
                ...
                <div class="modal-footer">
                    <button id="save" class="btn btn-primary">Save Airline
...
<script src="scripts/WebForms/airline.js"></script>
</asp:Content>
