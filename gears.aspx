<%@ Page Title="Working Gears" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="gears.aspx.cs" Inherits="Seabase.gears" %>
                ...
                <div class="col-md-12">
                      <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title animated slideInRight">Working Gears</h3>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-8">
                                            <button data-toggle="modal" data-target="#addModal" class="btn btn-primary btn-add">
                                              Add New Working Gear
                                                <span class="tooltiptext">Click to add new working gear</span>
                                            </button>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="text-primary">Working Gear Name:</label><br />
                ...
                <div class="modal-footer">
                    <button id="save" class="btn btn-primary">Save Working Gear
...
<script src="scripts/WebForms/gear.js"></script>
</asp:Content>
