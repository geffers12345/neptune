<%@ Page Title="Seaports" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="seaports.aspx.cs" Inherits="Seabase.seaports" %>
                ...
                <div class="col-md-12">
                      <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title animated slideInRight">Seaports</h3>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-8">
                                            <button data-toggle="modal" data-target="#addModal" class="btn btn-primary btn-add">
                                              Add New Port 
                                                <span class="tooltiptext">Click to add new seaport</span>
                                            </button>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="text-primary">Port Name:</label><br />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-primary">Port Code:</label><br />
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-info text-primary"></i></span>
                                    <input type="text" id="code" placeholder="Port Code" class="form-control" data-name="Code"/>
                                </div>
                ...
                <div class="modal-footer">
                    <button id="save" class="btn btn-primary">Save Port
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-info text-primary"></i></span>
                                    <input type="text" id="code-view" placeholder="Port Code" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-info text-primary"></i></span>
                                    <select class="form-control" id="country-view">
                                        <option value="">--SELECT COUNTRY--</option>
                                        <option value="Afghanistan">Afghanistan</option>
                                        <option value="Åland Islands">Åland Islands</option>
                                        <option value="Albania">Albania</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-info text-primary"></i></span>
                                    <input type="text" id="code-edit" placeholder="Port Code" class="form-control" data-name="Code"/>
                                </div>
...
<script src="scripts/WebForms/seaport.js"></script>
</asp:Content>
