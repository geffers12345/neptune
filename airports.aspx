<%@ Page Title="Airports" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="airports.aspx.cs" Inherits="Seabase.airports" %>
                ...
                <div class="col-md-12">
                      <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title animated slideInRight">Airports</h3>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-8">
                                            <button data-toggle="modal" data-target="#addModal" class="btn btn-primary btn-add">
                                              Add New Port 
                                                <span class="tooltiptext">Click to add new Airport</span>
                                            </button>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
...
<script src="scripts/WebForms/airport.js"></script>
</asp:Content>
