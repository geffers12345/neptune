<%@ Page Title="Clinics" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="clinics.aspx.cs" Inherits="Seabase.clinics" %>
                ...
                <div class="col-md-12">
                      <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title animated slideInRight">Clinics</h3>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-8">
                                            <button data-toggle="modal" data-target="#addModal" class="btn btn-primary btn-add">
                                              Add New Clinic
                                                <span class="tooltiptext">Click to add new clinic</span>
                                            </button>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="text-primary">Clinic Name:</label><br />
                ...
                <div class="modal-footer">
                    <button id="save" class="btn btn-primary">Save Clinic
...
<script src="scripts/WebForms/clinic.js"></script>
</asp:Content>
