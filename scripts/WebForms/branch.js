...
function get() {
    ...
    (new http).post("branches.aspx/get", {
...
$(document).on('click', '#save', function () {
    if (isInputValid()) {
        ...
        (new http).post("branches.aspx/insert", {
            name: $('#name').val(),
...
$(document).on('click', '.view', function () {
    ...
    (new http).post("branches.aspx/find", {
        id: id
    }).then(function (response) {
...
$(document).on('click', '#saveChanges', function () {
    if (isInputEditValid()) {
        ...
        (new http).post("branches.aspx/update", {
            id: id,
            name: $('#name-edit').val(),
...
$(document).on('click', '.remove', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("branches.aspx/delete", {
                id: id,
                name: name
            }).then(function (response) {
