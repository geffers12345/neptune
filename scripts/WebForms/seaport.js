...
function get() {
    ...
    (new http).post("seaports.aspx/get", {
...
$(document).on('click', '#save', function () {
    if (isInputValid()) {
        ...
        (new http).post("seaports.aspx/insert", {
            name: $('#name').val(),
            code: $('#code').val(),
            country: $('#country').val()
        }).then(function (response) {
...
$(document).on('click', '.view', function () {
    ...
    (new http).post("seaports.aspx/find", {
        id: id
    }).then(function (response) {
...
$(document).on('click', '#saveChanges', function () {
    if (isInputEditValid()) {
        ...
        (new http).post("seaports.aspx/update", {
            id: id,
            name: $('#name-edit').val(),
            code: $('#code-edit').val(),
...
$(document).on('click', '.remove', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("seaports.aspx/delete", {
                id: id,
                name: name
            }).then(function (response) {
