...
$(document).on('click', '#save', function () {
    if (isInputValid()) {
        ...
        (new http).post("agents.aspx/insert", {
            name: $('#name').val(),
            address: $('#address').val(),
            phone: $('#phone').val(),
            fax: $('#fax').val()
...
$(document).on('click', '#saveChanges', function () {
    if (isInputEditValid()) {
        ...
        (new http).post("agents.aspx/update", {
            id: id,
            name: $('#name-edit').val(),
...
function isInputValid() {
    ...
    var b = $("#address").validate(['required']).displayErrorOn($("#error-address"));
    var c = $("#phone").validate(['required']).displayErrorOn($("#error-phone"));
...
function isInputEditValid() {
    ...
    var b = $("#address-edit").validate(['required']).displayErrorOn($("#error-address-edit"));
    var c = $("#phone-edit").validate(['required']).displayErrorOn($("#error-phone-edit"));
