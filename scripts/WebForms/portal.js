        ...
        var items = response.d.map(item => {
            return new Promise(function (resolve, reject) {
                ...
                var html = '<div class="col-md-4 card rank-' + item.RankID + '">' +
                    ...
                    '<tr>' +
                    '<td colspan="2">' +
                    '<a href="/applicant?_hsdlwhx=' + item.ID + '" target="_blank" class="button">View Profile</a>' +
                    '</td>' +
                    '</tr>' +
                    '</table>' +
                    '</div>';
...
function uniform(id) {
    (new http).post("portal.aspx/uniform", {
        id: id
    }).then(function (response) {
...
function benefit(id) {
    (new http).post("portal.aspx/benefit", {
        id: id
    }).then(function (response) {
...
function philhealth(id) {
    (new http).post("portal.aspx/philhealth", {
        id: id
    }).then(function (response) {
...
function family(id) {
    (new http).post("portal.aspx/family", {
        id: id
    }).then(function (response) {
...
$(document).on('click', '#save-changes-benefits', function () {
    (new http).post("portal.aspx/update_benefits", {
        crewID: applicantID,
        sss: $('#sss').val(),
...
$(document).on('click', '#save-changes-philhealth', function () {
    (new http).post("portal.aspx/update_philhealth", {
        crewID: applicantID,
...
$(document).on('click', '#save-changes-family', function () {
    (new http).post("portal.aspx/update_family", {
        crewID: applicantID,
        father: $('#father').val(),
        mother: $('#mother').val(),
        spouse: $('#spouse').val(),
...
$(document).on('click', '#save-child', function () {
    ...
    if (isChildValid()) {
        (new http).post("portal.aspx/insert_child", {
            crewID: applicantID,
            name: $('#child-name').val(),
...
$(document).on('click', '.remove-child', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_child", {
                id: childID
            }).then(function (response) {
...
function children(id) {
    ...
    (new http).post("portal.aspx/children", {
        id: id
    }).then(function (response) {
...
$(document).on('click', '#save-bfcry', function () {
    ...
    if (isBeneficiaryValid()) {
        (new http).post("portal.aspx/insert_beneficiary", {
            crewID: applicantID,
            name: $('#bfcry-name').val(),
...
$(document).on('click', '.remove-beneficiary', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_beneficiary", {
                id: benID
            }).then(function (response) {
...
function beneficiary(id) {
    ...
    (new http).post("portal.aspx/beneficiary", {
        id: id
    }).then(function (response) {
...
$(document).on('click', '#save-educ', function () {
    ...
    if (isEducValid()) {
        (new http).post("portal.aspx/insert_educ", {
            crewID: applicantID,
            course: $('#course').val(),
            school: $('#school').val(),
...
$(document).on('click', '.remove-educ', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_educ", {
                id: benID
            }).then(function (response) {
...
function education(id) {
    ...
    (new http).post("portal.aspx/education", {
        id: id
    }).then(function (response) {
...
$(document).on('click', '#save-license', function (e) {
    ...
    if (isLicenseValid()) {
        (new http).post("portal.aspx/insert_license", {
            crewID: applicantID,
...
function license() {
    ...
    (new http).post("portal.aspx/licenses", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '.remove-license', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_license", {
                id: licenseID
            }).then(function (response) {
...
$(document).on('click', '#save-flag', function (e) {
    ...
    if (isFlagValid()) {
        (new http).post("portal.aspx/insert_flag", {
            crewID: applicantID,
            flagID: $('#flag').val(),
...
function flag() {
    ...
    (new http).post("portal.aspx/flags", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '.remove-flag', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_flag", {
                id: flagID
            }).then(function (response) {
...
$(document).on('click', '#save-travel', function (e) {
    ...
    if (isTravelValid()) {
        (new http).post("portal.aspx/insert_travel", {
            crewID: applicantID,
            docID: $('#document').val(),
...
$(document).on('click', '#save-travel-edit', function (e) {
    ...
    if (isTravelEditValid()) {
        (new http).post("portal.aspx/update_travel", {
...
function travel() {
    ...
    (new http).post("portal.aspx/travels", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '.remove-travel', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_travel", {
                id: itemID
            }).then(function (response) {
...
$(document).on('click', '.edit-travel', function () {
    ...
    (new http).post("portal.aspx/find_travels", {
        id: itemID
    }).then(function (response) {
...
$(document).on('click', '#save-training', function (e) {
    ...
    if (isTrainingValid()) {
        ...
        (new http).post("portal.aspx/insert_training", {
            crewID: applicantID,
...
$(document).on('click', '#save-training-changes', function (e) {
    ...
    if (isTrainingEditValid()) {
        ...
        (new http).post("portal.aspx/update_training", {
            id: trainingItemID,
            crewID: applicantID,
...
function training_courses() {
    ...
    (new http).post("portal.aspx/trainings", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '.remove-training', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_training", {
                id: itemID
            }).then(function (response) {
...
$(document).on('click', '.edit-training', function () {
    ...
    (new http).post("portal.aspx/find_training", {
        id: itemID
    }).then(function (response) {
...
$(document).on('click', '#save-library', function (e) {
    ...
    if (isLibraryValid()) {
        ...
        (new http).post("portal.aspx/insert_library", {
            crewID: applicantID,
            name: $('#library').val(),
...
function libraries() {
    ...
    (new http).post("portal.aspx/libraries", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '.remove-library', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_library", {
                id: itemID
            }).then(function (response) {
...
$(document).on('click', '#save-med', function (e) {
    ...
    if (isMedValid()) {
        (new http).post("portal.aspx/insert_medical", {
            crewID: applicantID,
            medical: $('#medical').val(),
            clinic: $('#clinic').val(),
...
function crew_medicals() {
    ...
    (new http).post("portal.aspx/medicals", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '.remove-med', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_medical", {
                id: itemID
            }).then(function (response) {
...
$(document).on('click', '#save-vaccine', function (e) {
    ...
    if (isVaccineValid()) {
        (new http).post("portal.aspx/insert_vaccine", {
            crewID: applicantID,
            vaccine: $('#vaccine').val(),
...
function crew_vaccines() {
    ...
    (new http).post("portal.aspx/vaccines", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '.remove-vaccine', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_vaccine", {
                id: itemID
            }).then(function (response) {
...
$(document).on('click', '#save-work', function (e) {
    ...
    if (isWorkValid()) {
        (new http).post("portal.aspx/insert_work", {
            crewID: applicantID,
            rank: $('#work-rank').val(),
...
function crew_works() {
    ...
    (new http).post("portal.aspx/works", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '.remove-work', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_work", {
                id: itemID
            }).then(function (response) {
...
$(document).on('click', '#accept-crew', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/hire", {
                crewID: applicantID,
                statusID: 7,
                vesselID: parseInt($('#vessel').val())
            }).then(function (response) {

                (new http).post("portal.aspx/crewGroup", {
                    crewID: applicantID,
...
function crewGroup() {
    (new http).post("portal.aspx/findCrewGroup", {
        crewID: applicantID
    }).then(function (response) {
...
$(document).on('click', '#change-principal-vessel', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/changePrincipal", {
                crewID: applicantID,
...
$(document).on('click', '#send-crew', function () {
    (new http).post("portal.aspx/send", {
        crewID: applicantID,
...
function histories(id) {
    ...
    (new http).post("portal.aspx/histories", {
        id: id
    }).then(function (response) {
...
$(document).on('click', '#save-exp', function (e) {
    ...
    if (isExpValid()) {
        (new http).post("portal.aspx/insert_exp", {
            crewID: applicantID,
            rank: $('#exp-rank').val(),
...
function crew_exps() {
    ...
    (new http).post("portal.aspx/exps", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '.remove-exp', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("portal.aspx/delete_exp", {
                id: itemID
            }).then(function (response) {
...
$(document).on('click', '#save-eval', function (e) {
    ...
    (new http).post("portal.aspx/insert_eval", {
        crewID: applicantID,
...
function evaluations() {
    ...
    (new http).post("portal.aspx/evaluations", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '#save-remarks', function (e) {
    ...
    (new http).post("portal.aspx/insert_remark", {
        crewID: applicantID,
...
function remarks() {
    ...
    (new http).post("portal.aspx/remarks", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '#save-incident', function (e) {
    ...
    (new http).post("portal.aspx/insert_incident", {
        crewID: applicantID,
...
function incidents() {
    ...
    (new http).post("portal.aspx/incidents", {
        id: applicantID
    }).then(function (response) {
...
$(document).on('click', '#save-allotee', function (e) {
    ...
    if (isAlloteeValid()) {
        ...
        (new http).post("portal.aspx/insert_allotee", {
            crewID: applicantID,
            allotee: $('#allotee').val(),
...
function allotees() {
    ...
    (new http).post("portal.aspx/allotees", {
        id: applicantID
    }).then(function (response) {
...
function numbers() {
    ...
    (new http).post("portal.aspx/numbers", {
        id: applicantID,
        date: formattedDate
    }).then(function (response) {
