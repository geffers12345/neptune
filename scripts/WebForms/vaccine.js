...
$(document).on('click', '#save', function () {
    if (isInputValid()) {
        ...
        (new http).post("vaccines.aspx/insert", {
            name: $('#name').val(),
            days: $('#days').val(),
            required: required
        }).then(function (response) {
...
$(document).on('click', '.view', function () {
    ...
    (new http).post("vaccines.aspx/find", {
        id: id
    }).then(function (response) {
...
$(document).on('click', '#saveChanges', function () {
    if (isInputEditValid()) {
        ...
        (new http).post("vaccines.aspx/update", {
            id: id,
            name: $('#name-edit').val(),
            days: $('#days-edit').val(),
            required: required
...
$(document).on('click', '.remove', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("vaccines.aspx/delete", {
                id: id,
                name: name
            }).then(function (response) {
...
function isInputValid() {
    ...
    var c = $("#days").validate(['required']).displayErrorOn($("#error-days"));
...
function isInputEditValid() {
    ...
    var c = $("#days-edit").validate(['required']).displayErrorOn($("#error-days-edit"));
