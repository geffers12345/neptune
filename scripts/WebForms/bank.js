...
$(document).on('click', '#save', function () {
    if (isInputValid()) {
        ...
        (new http).post("banks.aspx/insert", {
            name: $('#name').val(),
            code: $('#code').val()
        }).then(function (response) {
...
$(document).on('click', '#saveChanges', function () {
    if (isInputEditValid()) {
        ...
        (new http).post("banks.aspx/update", {
            id: id,
            name: $('#name-edit').val(),
            code: $('#code-edit').val()
        }).then(function (response) {
...
$(document).on('click', '.remove', function () {
    ...
    swal({
        ...
        if (isConfirm.value == true) {
            (new http).post("banks.aspx/delete", {
                id: id,
                name: name
            }).then(function (response) {
