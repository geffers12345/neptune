<%@ Page Title="Vessel Union" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="unions.aspx.cs" Inherits="Seabase.unions" %>
                ...
                <div class="col-md-12">
                      <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title animated slideInRight">Vessel Unions</h3>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-8">
                                            <button data-toggle="modal" data-target="#addModal" class="btn btn-primary btn-add">
                                              Add New Vessel Union
                                                <span class="tooltiptext">Click to add new vessel union</span>
                                            </button>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="text-primary">Vessel Union Name:</label><br />
                ...
                <div class="modal-footer">
                    <button id="save" class="btn btn-primary">Save Vessel Union
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-info text-primary"></i></span>
                                    <textarea id="desc-edit" placeholder="Description" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
...
<script src="scripts/WebForms/union.js"></script>
</asp:Content>
