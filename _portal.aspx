<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="_portal.aspx.cs" Inherits="Seabase.portal" %>

<!DOCTYPE html>

<style>
body {
   background-image: url("content/img/the-mission-to-seafarers-6.jpg");
    ...
    <div class="col-md-12">
        <div class="login">
            ...
            <div class="login-header">
                <span class="brand-name" style="display: inline;"><b>Neptune</b> | Crew Portal</span>
            </div>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#btnLogin', function (e) {
            ...
            if (isInputValid()) {
                ...
                (new http).post('_portal.aspx/login', {
                    email: $('#email').val(),
                    password: $('#password').val()
                }).then(function (data) {
                    if (data.d != 0) {
                        var url = '/crew-dashboard?_hsdlwhx=' + data.d;
