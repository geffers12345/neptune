<%@ Page Title="Medical Certificates" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="medicals.aspx.cs" Inherits="Seabase.medicals" %>
                ...
                <div class="col-md-12">
                      <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title animated slideInRight">Medical Certificates</h3>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="text-primary">Medical Certificate Name:</label><br />
                ...
                <div class="modal-footer">
                    <button id="save" class="btn btn-primary">Save Medical Certificate
...
<script src="scripts/WebForms/medical.js"></script>
</asp:Content>
