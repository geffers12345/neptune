				...
				<table width=94% align=center border="0" cellpadding="2">
					<tr>
					  ...
					  <td  rowspan="2" valign="top" width="13%"><b><u>TYPE</u></b></td>		
						...
						<td   rowspan="2" width=11% valign="top"><b><u>RANK <!-- OCCUPIED--> </b></td>	

						<td  colspan="2" width="20%"><b><u>Service Record</b></td>
						
						<td  width=17% rowspan="2" valign="top"><b><u>TRADE AREA</b></td>	
					</tr>		
					
					<tr>
                        <td width="20%"> <b><u>From</b></u>&nbsp;&nbsp;&nbsp;</td>
                        <td width="20%"> <b><u>To</u></b> </td> </tr>
										<tr>											
     				<td id="vessel-view"></td>
					<td id="vessel-type"></td>
					<td id="position"></td>	
					<td id="embarkation-date"></td>							
					<td id="disembarkation-date"></td>
					<td align="center">World Wide</td>			
				</tr>
                    <tr>											
     				<td ></td>
					<td >
