<%@ Page Title="Crew Informations" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="applicant.aspx.cs" Inherits="Seabase.applicant" %>
                                ...
                                <div class="row">
                                    <div style="overflow: auto; padding-right: 7%; margin-top: 5%;">
                                        ...
                                        <section id="content9">
                                            ...
                                            <div class="col-md-12 section-header">
                                                <h3 class="animated slideInRight">Evaluations</h3>
                                            </div>

                                            <div class="col-md-12">
                                                <button class="btn btn-primary" data-toggle="modal" data-target="#add-eval-modal">Add New Evaluation</button>
                                            </div>

                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table id="evaluation-table" style="width: 100%;">
                                                        <thead>
                                                            <tr>
                                                                <td>Vessel</td>
                                                                <td>Rank</td>
                                        ...
                                        <section id="content10">
                                            ...
                                            <div class="col-md-12 section-header">
                                                <h3 class="animated slideInRight">Office Remarks</h3>
                                            </div>

                                            <div class="col-md-12">
                                                <label>Name</label>
                                                <input type="text" id="remark-name" placeholder="Name" class="form-control" disabled />
                                            </div>

                                            <div class="col-md-12">
                                                <label>Remarks</label>
                                                <textarea id="remark-remarks" placeholder="Type remarks here.." class="form-control"></textarea>
                                            </div>

                                            <div class="col-md-12">
                                                <button id="save-remarks" class="btn btn-primary">Save Remarks
                                                    <i class="fa fa-spinner fa-spin hidden"></i>
                                                </button>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table id="remark-table" style="width: 100%;">
                                                        <thead>
                                                            <tr>
                                                                <td>Date</td>
                                                                <td>Time</td>
                                            ...
                                            <div class="col-md-12">
                                                <label>Remarks</label>
                                                <textarea id="incident-remarks" placeholder="Type remarks here.." class="form-control"></textarea>
                                            </div>

                                            <div class="col-md-12">
                                                <button id="save-incident" class="btn btn-primary">Save Incident
                                                    <i class="fa fa-spinner fa-spin hidden"></i>
                                                </button>
                                            </div>
